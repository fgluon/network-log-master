...
The collector clean-machine installer still needs final Grafana administrator/bootstrap/dashboard integration and package no-autostart hardening before the collector rebuild milestone is closed.
